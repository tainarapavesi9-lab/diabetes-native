(function () {
  var mail = '<a href="mailto:support@grayfieldreview.online">support@grayfieldreview.online</a>';
  var contactBlock = "<p>Grayfield Review<br>grayfieldreview.online<br>" + mail + "</p>";
  ...
  var pages = {
    privacy: ["Privacy Policy",
      ...
      "<p>This Privacy Policy explains how Grayfield Review (\"we\", \"us\") collects and uses information when you visit this website.</p>" +
      ...
      "<li>Depending on where you live (for example California, the European Union or the United Kingdom), you may have the right to access, correct or delete personal information we hold about you, and to opt out of certain uses. To make a request, contact us at " + mail + ".</li></ul>" +
    ...
    terms: ["Terms of Use",
      '<p class="legal-updated">Last updated: September 15, 2026</p>' +
      "<p>By using Grayfield Review (the \"website\"), you agree to these Terms of Use. If you do not agree, please do not use the website.</p>" +
      ...
      "<h3>6. Limitation of liability</h3><p>To the fullest extent allowed by law, Grayfield Review is not liable for any damages arising from your use of the website or from any product purchased through links on the website.</p>" +
      "<h3>7. Intellectual property</h3><p>The text, images and design of this website belong to Grayfield Review or its licensors. You may not copy or republish them without permission.</p>" +
    ...
    disclaimer: ["Disclaimer",
      "<h3>Medical disclaimer</h3><p>The information on this website is for educational purposes only and is not intended as medical advice, diagnosis or treatment. Do not stop, start or change any medication without talking to your doctor. If you have diabetes or prediabetes, or take glucose-lowering medication, consult your healthcare provider before using any dietary supplement.</p>" +
      ...
      "<h3>Advertising disclosure</h3><p>Some articles on Grayfield Review are advertorials. They are labeled as sponsored content and are not independent news articles. We may receive a commission from purchases made through links in those articles. Our educational articles do not contain affiliate links.</p>" +
    ...
    contact: ["Contact",
      "<p>For questions about the content of Grayfield Review, corrections or privacy requests:</p>" + contactBlock +
